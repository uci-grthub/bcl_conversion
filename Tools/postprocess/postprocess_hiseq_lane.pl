...
my $process_single="/home/sequser/Facility/Tools/analyze_single_reads.pl";
my $process_paired="/home/sequser/Facility/Tools/analyze_paired_reads.pl";
...
# Process Lane (Case Multiplexed)
  ...
  if($prefix!~/^(4R|R)[0-9]{3}-L$lane$/){ print "Cannot process trash\n"; exit 1; }
