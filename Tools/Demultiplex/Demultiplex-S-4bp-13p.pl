...
my $outP01="R45-L7-P01-AGGG-Sequences.txt"; my $outP02="R45-L7-P02-CCAT-Sequences.txt";
my $outP03="R45-L7-P03-GTCA-Sequences.txt"; my $outP04="R45-L7-P04-TATC-Sequences.txt";
my $outP05="R45-L7-P05-AAAA-Sequences.txt"; my $outP06="R45-L7-P06-CTGC-Sequences.txt";
my $outP07="R45-L7-P07-GCTG-Sequences.txt"; my $outP08="R45-L7-P08-TGCT-Sequences.txt";
my $outP09="R45-L7-P09-ATTT-Sequences.txt"; my $outP10="R45-L7-P10-CACG-Sequences.txt";
my $outP11="R45-L7-P11-GGAC-Sequences.txt"; my $outP12="R45-L7-P12-TCGA-Sequences.txt";
my $outP13="R45-L7-P13-GAGT-Sequences.txt"; my $outPUN="R45-L7-PNotReco-Sequences.txt";
my $fastq="R45-L7-Sequences.txt";

my @seq=("AGGG","CCAT","GTCA","TATC","AAAA","CTGC","GCTG","TGCT","ATTT","CACG","GGAC","TCGA","GAGT");
my @seq1=(".GGG",".CAT",".TCA",".ATC",".AAA",".TGC",".CTG",".GCT",".TTT",".ACG",".GAC",".CGA",".AGT");
my @seq2=("A.GG","C.AT","G.CA","T.TC","A.AA","C.GC","G.TG","T.CT","A.TT","C.CG","G.AC","T.GA","G.GT");
my @seq3=("AG.G","CC.T","GT.A","TA.C","AA.A","CT.C","GC.G","TG.T","AT.T","CA.G","GG.C","TC.A","GA.T");
my @seq4=("AGG.","CCA.","GTC.","TAT.","AAA.","CTG.","GCT.","TGC.","ATT.","CAC.","GGA.","TCG.","GAG.");
...
open(OUTP13,">$outP13") || die "Cannot open output file"; open(OUTPUN,">$outPUN") || die "Cannot open output file";
...
while($l=<IN>)
{
  if($l =~ /^@/)
  {
    ...
    if(($s40 eq $seq[12])&&($f==1)){ $Res[0]++; $Res[1]++; $f=0; print OUTP13 "$entS"; }
    ...
    if(($s40 =~ $seq1[12])&&($f==1)){ $Res[0]++; $Res[2]++; $f=0; print OUTP13 "$entS"; }
    ...
    if(($s40 =~ $seq2[12])&&($f==1)){ $Res[0]++; $Res[3]++; $f=0; print OUTP13 "$entS"; }
    ...
    if(($s40 =~ $seq3[12])&&($f==1)){ $Res[0]++; $Res[4]++; $f=0; print OUTP13 "$entS"; }
    ...
    if(($s40 =~ $seq4[12])&&($f==1)){ $Res[0]++; $Res[5]++; $f=0; print OUTP13 "$entS"; }
...
close(OUTP11); close(OUTP12); close(OUTP13); close(OUTPUN); close(IN);
