...
my $fastqR1 ="R145-L1-READ1-Sequences.txt";            my $fastqR2 ="R145-L1-READ2-Sequences.txt";
my $outP01R1="R145-L1-P1-ATGTCA-READ1-Sequences.txt";  my $outP01R2="R145-L1-P1-ATGTCA-READ2-Sequences.txt";
my $outP02R1="R145-L1-P2-GGTAGC-READ1-Sequences.txt";  my $outP02R2="R145-L1-P2-GGTAGC-READ2-Sequences.txt";
my $outP03R1="R145-L1-P3-ACTGAT-READ1-Sequences.txt";  my $outP03R2="R145-L1-P3-ACTGAT-READ2-Sequences.txt";
my $outP04R1="R145-L1-P4-CACGAT-READ1-Sequences.txt";  my $outP04R2="R145-L1-P4-CACGAT-READ2-Sequences.txt";
my $outP05R1="R145-L1-P5-CTAGCT-READ1-Sequences.txt";  my $outP05R2="R145-L1-P5-CTAGCT-READ2-Sequences.txt";
my $outP06R1="R145-L1-P6-TCATTC-READ1-Sequences.txt";  my $outP06R2="R145-L1-P6-TCATTC-READ2-Sequences.txt";
my $outP07R1="R145-L1-P7-GGCTAC-READ1-Sequences.txt";  my $outP07R2="R145-L1-P7-GGCTAC-READ2-Sequences.txt";
my $outPUNR1="R145-L1-PrNotRecog-READ1-Sequences.txt"; my $outPUNR2="R145-L1-PrNotRecog-READ2-Sequences.txt";

my @s  =("ATGTCA","GGTAGC","ACTGAT","CACGAT","CTAGCT","TCATTC","GGCTAC");
my @s1 =(".TGTCA",".GTAGC",".CTGAT",".ACGAT",".TAGCT",".CATTC",".GCTAC");
my @s2 =("A.GTCA","G.TAGC","A.TGAT","C.CGAT","C.AGCT","T.ATTC","G.CTAC");
my @s3 =("AT.TCA","GG.AGC","AC.GAT","CA.GAT","CT.GCT","TC.TTC","GG.TAC");
my @s4 =("ATG.CA","GGT.GC","ACT.AT","CAC.AT","CTA.CT","TCA.TC","GGC.AC");
my @s5 =("ATGT.A","GGTA.C","ACTG.T","CACG.T","CTAG.T","TCAT.C","GGCT.C");
my @s6 =("ATGTC.","GGTAG.","ACTGA.","CACGA.","CTAGC.","TCATT.","GGCTA.");
...
while(($l1=<IN1>)&&($l2=<IN2>))
{
  if(($l1 =~ /^@/)&&($l2 =~ /^@/))
  {
    ...
    my $entR1="$h1R1\n$s1R1\n$h2R1\n$s2R1\n"; my $entR2="$h1R2\n$s1R2\n$h2R2\n$s2R2\n";
    my $entSR1="$h1R1\n".substr($s1R1,6)."\n$h2R1\n".substr($s2R1,6)."\n";
    $num_seq++; my $s60=substr($s1R1,0,6);  my $f=1;
...
close(OUTP07R1); close(OUTP07R2); close(OUTPUNR1); close(OUTPUNR2);
close(IN1);      close(IN2);
