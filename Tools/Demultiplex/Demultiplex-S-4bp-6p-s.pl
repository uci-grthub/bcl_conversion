...
my $outP01="nR013-L1-P1-GGCG-Sequences.txt";
my $outP02="nR013-L1-P2-GGTC-Sequences.txt";
my $outP03="nR013-L1-P3-CGGA-Sequences.txt";
my $outP04="nR013-L1-P4-TTAG-Sequences.txt";
my $outP05="nR013-L1-P5-CCGG-Sequences.txt";
my $outP06="nR013-L1-P6-CCAC-Sequences.txt";
my $outPUN="nR013-L1-PrNotRecog-Sequences.txt";
my $fastq="nR013-L1-Sequences.txt";
my @seq=("GGCG","GGTC","CGGA","TTAG","CCGG","CCAC");
...
close(OUTP04); close(OUTP05); close(OUTP06); close(OUTPUN); close(IN);
