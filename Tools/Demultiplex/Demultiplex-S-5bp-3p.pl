...
my $fastq="R180-L5-Sequences.txt";
my $outP01="R180-L5-P1-CTAGT-Sequences.txt";
my $outP02="R180-L5-P2-TGCAG-Sequences.txt";
my $outP03="R180-L5-P3-ACGTC-Sequences.txt";
my $outPUN="R180-L5-PrNotRecog-Sequences.txt";

my @seq=("CTAGT","TGCAG","ACGTC");
my @seq1=(".TAGT",".GCAG",".CGTC");
my @seq2=("C.AGT","T.CAG","A.GTC");
my @seq3=("CT.GT","TG.AG","AC.TC");
my @seq4=("CTA.T","TGC.G","ACG.C");
my @seq5=("CTAG.","TGCA.","ACGT.");
...
close(OUTP01); close(OUTP02); close(OUTP03); close(OUTPUN); close(IN);
