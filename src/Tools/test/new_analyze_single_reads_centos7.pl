...
my $basic_description="$prefix-READ3-SampleBasicInfo.txt";
my $gnuplot_phred_out="$prefix-READ3-PhredQualScores.png";
my $gnuplot_calls_out="$prefix-READ3-BaseComposition.png";
