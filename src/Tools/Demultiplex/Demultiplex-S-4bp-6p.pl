...
my $outP01="R62-L1-P1-ACCC-Sequences.txt";
my $outP02="R62-L1-P2-CGTA-Sequences.txt";
my $outP03="R62-L1-P3-GAGT-Sequences.txt";
my $outP04="R62-L1-P4-TTAG-Sequences.txt";
my $outP05="R62-L1-P5-AGGG-Sequences.txt";
my $outP06="R62-L1-P6-GTCA-Sequences.txt";
my $outPUN="R62-L1-PNotRec-Sequences.txt";
my $fastq="R62-L1-Sequences.txt";
...
close(OUTP06); close(OUTPUN); close(IN);
